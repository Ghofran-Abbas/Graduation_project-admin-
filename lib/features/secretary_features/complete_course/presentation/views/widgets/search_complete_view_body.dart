...
class SearchCompleteViewBody extends StatelessWidget {
  SearchCompleteViewBody({super.key});
                    ...
                    state.course.courses.data!.isNotEmpty ? GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Align(child: CustomCard(
                          ...
                          showIcons: true,
                          onTap: () {
                            context.go('${GoRouterPath.completeDetails}/${state.course.courses.data![index].id}');
                          },
                          onTapFirstIcon: (){},
                          onTapSecondIcon: () {},
                        ));
