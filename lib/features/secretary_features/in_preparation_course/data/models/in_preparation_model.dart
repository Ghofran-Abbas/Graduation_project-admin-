class InPreparationModel {
  final int currentPage;
  final List<DatumInPreparation>? data;
  ...
  factory InPreparationModel.fromJson(Map<String, dynamic> json) => InPreparationModel(
    currentPage: json["current_page"],
    data: List<DatumInPreparation>.from(json["data"].map((x) => DatumInPreparation.fromJson(x))),
...
class DatumInPreparation {
  ...
  factory DatumInPreparation.fromJson(Map<String, dynamic> json) => DatumInPreparation(
    id: json["id"],
    name: json["name"],
