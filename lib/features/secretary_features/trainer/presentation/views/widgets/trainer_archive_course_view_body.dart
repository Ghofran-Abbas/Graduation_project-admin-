...
class TrainerArchiveCourseViewBody extends StatelessWidget {
  const TrainerArchiveCourseViewBody({super.key});
                ...
                /*state.courses.courses.data!.isNotEmpty ? */GridView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Align(child: CustomCard(
                      ...
                      onTap: () {
                        context.go('${GoRouterPath.trainerDetails}/1${GoRouterPath.trainerArchiveCourseView}/1${GoRouterPath.archiveSectionTrainerView}/1');
