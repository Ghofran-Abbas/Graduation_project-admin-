class ConfirmedStudentsSectionModel {
  final String message;
  final Students students;

  ConfirmedStudentsSectionModel({
    required this.message,
    required this.students,
  });

  factory ConfirmedStudentsSectionModel.fromJson(Map<String, dynamic> json) => ConfirmedStudentsSectionModel(
