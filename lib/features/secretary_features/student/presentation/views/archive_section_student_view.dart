...
import 'widgets/archive_section_student_view_body.dart';

class ArchiveSectionStudentView extends StatelessWidget {
  const ArchiveSectionStudentView({super.key, required this.sectionId, required this.courseId, required this.studentId});
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: ArchiveSectionStudentViewBody(sectionId: sectionId, studentId: studentId,),
    );
  }
}
